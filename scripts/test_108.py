#!/usr/bin/env python3
"""Outro 1.0.8 verification suite — run 3 times before delivery.
...
check("A4 versionName 1.0.8", "versionName='1.0.8'" in badging)
check("A5 versionCode 9", "versionCode='9'" in badging)
...
check("B26 SettingsScreen about line says Outro 1.0.8",
      '"Outro 1.0.8' in sett)
