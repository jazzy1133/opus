...
fun main() {
    ...
    println("== ThemeController ==")
    ThemeController.init("dark")
    check("default dark after init(dark)", ThemeController.mode.value == "dark")
    ThemeController.set("light")
    check("set light", ThemeController.mode.value == "light")
    ThemeController.set("dark")
    check("set dark", ThemeController.mode.value == "dark")
    ThemeController.init("bogus")
    check("unknown value falls back to dark", ThemeController.mode.value == "dark")
    ThemeController.init("light")
    check("init light", ThemeController.mode.value == "light")
    check("label dark", ThemeController.label("dark") == "Dark")
    check("label light", ThemeController.label("light") == "Light")
